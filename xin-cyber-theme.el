...
(custom-theme-set-faces
 ...
 '(minibuffer-prompt ((t (:weight bold :foreground "#61CE3C" :background "#000000"))))
 '(highlight ((t (:underline (:color foreground-color :style line) :inverse-video nil :foreground "#ffffff" :background "#333333"))))
 '(region ((t (:foreground "#f6f3e8" :background "#7F073F"))))
 ...
 '(font-lock-doc-face ((t (:foreground "#cc99cc" :inherit (font-lock-string-face)))))
 ...
 '(mode-line-buffer-id ((t (:weight bold :foreground "gold"))))
